...
//     let milesAway: number = kilomitersAway * milesPerKilometer;
//     let hours: number = milesAway / speedMph;
//     return hours / 24;
//  }
 //console.log(`${spacecraftName} would take ${getDaysToLocation(kilomitersToMars)} days to get to Mars.`)
...
spaceShuttle.printDaysToLocation(new SpaceLocation('the Moon', kilometersToTheMoon));
 ...
 //console.log(`${spaceShuttle.name} would take ${spaceShuttle.getDaysToLocation(kilomitersToMars)} days to get to Mars.`)
